export const LEVELS = [
  {
    ...
    objective: {
      ...
      pendingStatus: 'Документ не найден. Сначала выполните цель.',
      completedTitle: 'Доберитесь до выхода',
      completedStatus: 'Документ получен. Избегайте охраны.',
      previewTitle: 'Запомните планировку банка',
      previewStatus: 'WASD двигает камеру осмотра. Через 15 секунд свет погаснет.',
      victoryTitle: 'Побег выполнен',
      victoryStatus: 'Статус: задание завершено',
      failureTitle: 'Задание провалено',
      failureStatus: 'Статус: попытка завершена',
    },
    exit: {
      x: -9,
      z: 8.4,
